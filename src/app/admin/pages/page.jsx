...
//     e.preventDefault();
//     const newDoctor = { ...doctorData, profilePicture, password, registrationDate: new Date().toLocaleDateString() };
...
//           <h1 className="text-3xl font-bold mb-8 text-white" style={{ fontFamily: 'Poppins, sans-serif' }}>
...
//                 {profilePicture && (
//                   <div className="mt-4">
//                     <img src={profilePicture} alt="Profile Preview" className="w-32 h-32 object-cover rounded-md border border-gray-300" />
//                   </div>
//                 )}
//               </div>
//               <div>
...
//                 </button>
//                 {password && (
//                   <p className="ml-4 text-gray-700">Generated Password: <strong>{password}</strong></p>
//                 )}
//               </div>
//             </div>
//             <div className="mt-6">
...
//           <h2 className="text-2xl font-bold mb-4 text-white">Registered Doctors</h2>
...
//                     <td className="px-6 py-4 whitespace-nowrap">{doctor.alumnus}</td>
//                     <td className="px-6 py-4 whitespace-nowrap">{doctor.yearsOfExperience}</td>
//                     <td className="px-6 py-4 whitespace-nowrap">{doctor.about}</td>
//                     <td className="px-6 py-4 whitespace-nowrap">{doctor.location}</td>
//                     <td className="px-6 py-4 whitespace-nowrap">{doctor.gender}</td>
//                     <td className="px-6 py-4 whitespace-nowrap">{doctor.registrationDate}</td>
//                     <td className="px-6 py-4 whitespace-nowrap">{doctor.password}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
