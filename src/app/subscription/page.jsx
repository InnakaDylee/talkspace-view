        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg max-w-lg w-full">
            ...
            <div className="space-y-4">
              <div
                className={`p-4 border rounded-lg cursor-pointer transition-colors ${selectedPlan === 'Premium' ? 'border-purple-700 bg-purple-50' : 'border-gray-300 hover:bg-gray-100'}`}
                onClick={() => handlePlanSelect('Premium')}
              >
                <h3 className="text-xl font-bold text-purple-700">Premium</h3>
                <p className="text-gray-600">Get full access to all features and content.</p>
              </div>
              <div
                className={`p-4 border rounded-lg cursor-pointer transition-colors ${selectedPlan === 'Standard' ? 'border-purple-700 bg-purple-50' : 'border-gray-300 hover:bg-gray-100'}`}
                onClick={() => handlePlanSelect('Standard')}
              >
                <h3 className="text-xl font-bold text-purple-700">Standard</h3>
                <p className="text-gray-600">Access to most features with limited content.</p>
              </div>
            </div>
            <div className="mt-6">
              <h4 className="text-lg font-semibold text-gray-800 mb-2">Subscription Type</h4>
